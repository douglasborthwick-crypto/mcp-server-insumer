...
Generate an ECDSA-signed wallet trust fact profile. 45 base checks across 26 chains in 5 dimensions — stablecoins (USDC + USDT across 22 EVM chains), governance, NFTs, staking, and institutional stablecoins (EURCV, USDCV, USDC, BENJI across Ethereum, Solana, XRPL, Stellar, Sui) — up to 50 checks across 28 chains in 9 dimensions with optional Solana, XRPL, Bitcoin, and Tron wallets. 3 credits (6 with merkle).
