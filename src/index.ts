...
const OnboardingChainId = z
  .union([
    z.enum(["1", "50", "56", "8453", "43114", "137", "42161", "10", "88888", "1868", "98866", "480", "146", "100", "5000", "534352", "59144", "324", "81457", "42220", "1284", "204", "130", "57073", "1329", "80094", "33139", "4663"]).transform(Number),
    z.number().int().refine(
      (n) => [1, 50, 56, 8453, 43114, 137, 42161, 10, 88888, 1868, 98866, 480, 146, 100, 5000, 534352, 59144, 324, 81457, 42220, 1284, 204, 130, 57073, 1329, 80094, 33139, 4663].includes(n),
  ...
  .describe("Merchant onboarding chain: an EVM chain ID from the merchant-registry set of 28 (1, 50 (XDC), 56, 8453, 43114, 137, 42161, 10, 146, 100, 5000, 534352, 59144, 324, 81457, 42220, 1284, 204, 130, 57073, 1329, 80094, 33139, 88888, 1868, 98866, 480, 4663 (Robinhood Chain)), 'solana', 'xrpl', 'bitcoin', 'tron', 'stellar', or 'sui'. Taiko, Ronin, Moonriver and Viction are excluded from the merchant registry but remain queryable via insumer_attest and insumer_trust.");
